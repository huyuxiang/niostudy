...
import daily.y2016.m06.d17.mayou.network.handler.ResultHandler;
...
public class Client {
	...
	public synchronized void start() {
		if(isStart) {
			...
			factory = new NioClientSocketChannelFactory(Executors.newFixedThreadPool(10), Executors.newFixedThreadPool(10), 2, 8);
