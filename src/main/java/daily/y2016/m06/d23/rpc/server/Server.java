package daily.y2016.m06.d23.rpc.server;
...
import daily.y2016.m06.d23.rpc.common.Entry;
import daily.y2016.m06.d23.rpc.common.Parameters;
import daily.y2016.m06.d23.rpc.common.Result;
import daily.y2016.m06.d23.rpc.method.MethodSupport;
import daily.y2016.m06.d23.rpc.network.handler.Decoder;
import daily.y2016.m06.d23.rpc.network.handler.Encoder;
import daily.y2016.m06.d23.rpc.network.handler.ParametersHandler;
...
public class Server {
	...
	public void execute(int seed) {
		while(isStart) {
			...
			try {
				Parameters parameters = Serializer.deserializer(entry.getColumn(), Parameters.class);
				Object result = methodSupport.invoke(parameters.getInterfaceName(), 
