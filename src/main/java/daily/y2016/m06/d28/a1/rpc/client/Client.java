package daily.y2016.m06.d28.a1.rpc.client;
...
import daily.y2016.m06.d28.a1.rpc.network.handler.ResultHandler;
...
public class Client {
		...
		if(isStart) {
			...
			bootstrap.setPipelineFactory(new ChannelPipelineFactory() {
				...
				public ChannelPipeline getPipeline() throws Exception {
					return Channels.pipeline(new Decoder(), new ResultHandler(Client.this), 
							new Encoder());
				}
			});
	...
	public ChannelFuture getConnection() {
		if(isStart) {
			return bootstrap.connect(new InetSocketAddress(remoteAddress, port));
		} else {
			throw new ClientStopException();
		}
	}
