package daily.y2016.m06.d28.a1.rpc.proxy;
...
import daily.y2016.m06.d28.a1.rpc.client.ClientFactory;
import daily.y2016.m06.d28.a1.rpc.common.Parameters;
import daily.y2016.m06.d28.a1.rpc.common.Result;
import daily.y2016.m06.d28.a1.rpc.serialize.SerializeException;
	...
	public BaseConsumerProxy(final String remoteAddress) {
		channelFutureLocal = new ThreadLocal<ChannelFuture>() {
			...
			protected ChannelFuture initialValue() {
				return ClientFactory.getClient().getConnection(remoteAddress, RpcFactory.DEFAULT_PORT);
			}
		};
	}
