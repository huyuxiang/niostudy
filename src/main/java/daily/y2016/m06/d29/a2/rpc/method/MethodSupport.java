package daily.y2016.m06.d29.a2.rpc.method;
...
public class MethodSupport {
	...
	public Object invoke(String methodName, Class<?>[] types, Object[] parameters) 
		throws InvocationTargetException, MethodUnRegisterException {
		FastClassWrapper wrapper = fastClassMap.get(methodName.substring(0, 
				methodName.lastIndexOf(".")));
		if(wrapper ==null) {
			throw new MethodUnRegisterException("methodName : not register " + methodName);
		}
