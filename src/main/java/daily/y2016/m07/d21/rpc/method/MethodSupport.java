package daily.y2016.m07.d21.rpc.method;
...
public class MethodSupport {
	...
	public Object invoke(String methodName, Class<?>[] types, Object[] parameters) throws 
		InvocationTargetException, MethodUnRegisterException {
		FastClassWrapper wrapper = fastClassMap.get(methodName.substring(0, 
				methodName.lastIndexOf(".")));
		if(wrapper==null) {
			throw new MethodUnRegisterException("methodName : " + methodName);
		}
