package daily.y2016.m08.d24.rpc.server;
...
import daily.y2016.m08.d24.rpc.common.Entry;
import daily.y2016.m08.d24.rpc.common.Parameters;
import daily.y2016.m08.d24.rpc.common.Result;
import daily.y2016.m08.d24.rpc.method.MethodSupport;
import daily.y2016.m08.d24.rpc.network.handler.Decoder;
import daily.y2016.m08.d24.rpc.network.handler.Encoder;
import daily.y2016.m08.d24.rpc.network.handler.ParametersHandler;
...
public class Server {
	...
	public synchronized void start() {
		if(!isStart) {
			...
			throw new RuntimeException("server start wrong");
		}
	}
	...
	public void putParameters(Channel channel, byte[] parameters) {
		if(isStart) {
			...
			throw new RuntimeException("server stop");
		}
	}
