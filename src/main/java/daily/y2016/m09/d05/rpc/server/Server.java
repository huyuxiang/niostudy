package daily.y2016.m09.d05.rpc.server;
...
import daily.y2016.m09.d05.rpc.common.Entry;
import daily.y2016.m09.d05.rpc.common.Result;
import daily.y2016.m09.d05.rpc.method.MethodSupport;
import daily.y2016.m09.d05.rpc.serialize.Serializer;
...
public class Server {
	...
	public void execute(int seed) {
		while(isStart) {
			...
			try {
				Parameters parameters = Serializer.deseriazlie(entry.getColumn(),
						Parameters.class);
