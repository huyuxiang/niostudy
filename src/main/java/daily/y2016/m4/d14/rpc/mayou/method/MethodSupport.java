package daily.y2016.m4.d14.rpc.mayou.method;
...
import daily.template.rpc.mayou.method.MethodUnRegisterException;

public class MethodSupport {

	private final ConcurrentMap<String, FastClassWrapper> fastClassMap = new 
			ConcurrentHashMap<String, FastClassWrapper>();
	
	public Object invoke(String methodName, Class<?>[] types, Object[] parameters) throws InvocationTargetException, MethodUnRegisterException {
		...
		return wrapper.fastClass.invoke(methodName.substring(methodName.lastIndexOf('.') + 1,
